...
public class DoiSoatCuocDAO {
	...
	public Map<String,Object> saveDoiSoatCuoc(String id,String doitac_id,Date sqlTuNgay,Date sqlDenNgay,String[] phulucs, String[] sucos,Date matlienlactu, Date matlienlacden) throws Exception {
		...
		stmt.setString(2, id);
		stmt.setString(3, doitac_id);
		stmt.setDate(4, sqlTuNgay);
		stmt.setDate(5, sqlDenNgay);
		stmt.setArray(6, arrPhuLuc);
		stmt.setArray(7, arrSuCo);
		stmt.setLong(8, System.currentTimeMillis());
		stmt.setDate(9, matlienlactu);
		stmt.setDate(10, matlienlacden);
		stmt.execute();
