--------------------------------------------------------
--  File created - Saturday-May-10-2014   
--------------------------------------------------------
--------------------------------------------------------
...
BEGIN
  ...
  if(cobienban_ is not null) then
    case 
      when cobienban_ = '1' then v_vcsqlwhere := v_vcsqlwhere ||' and sc.BIENBANVANHANH_ID <> 0 ';
      when cobienban_ = '0' then v_vcsqlwhere := v_vcsqlwhere ||' and sc.BIENBANVANHANH_ID = 0 ';
    end case;
  end if;
