...
<s:url action="doexport" namespace="/bangiao" id="doexportURL" />
...
<body>
	<form id="form" method="post" action="${doexportURL}">
		<div style="display:block;font-weight: bold;">Chọn các trường dữ liệu biên bản bàn giao cần xuất:</div>
		<table id="lstfields">
			<tr><td><input type="checkbox" value="" id="checkall" onclick="selectAll(this)"></input><label for="checkall">Chọn tất cả</label></td></tr>
			<tr>
				<td>
					<input type="checkbox" value="sobienban" name="fields"/>
