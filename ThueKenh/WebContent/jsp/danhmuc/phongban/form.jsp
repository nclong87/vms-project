	...
	<form id="form" onsubmit="return false;">
		...
		<div
			...
			<table class="input" style="width: 725px">
				...
				<tr>
					<td align="right"><label for="tenphongban">Tên phòng
							ban <font title="Bắt buộc nhập" color="red">*</font> :
					</label></td>
					<td align="left"><input type="text" id="tenphongban"
						name="opEdit.tenphongban"
						value="<s:property value="opEdit.tenphongban" />" /></td>
