...
<s:url action="ajLoadkhuvuc" namespace="/danhmuc" id="ajLoadData" />
<s:url action="editkhuvuc" namespace="/danhmuc" id="formURL" />
<s:url action="deletekhuvuc" namespace="/danhmuc" id="ajDeleteURL" />
...
<script>
	function doNew(link) {
		ShowWindow('Thêm khu vực mới', 800, 400, link, false);
	}
	function doEdit(link) {
		ShowWindow('Cập nhật khu vực', 800, 400, link, false);
	}
	function hasChecked() {
	...
	<div id="bg_wrapper">
			...
			<div class="s10">
				<div class="fl">
					...
					<div id="t_2" class="fl clg b tsc d">
						<div class="p3t">Quản lí khu vực</div>
					</div>
		...
		<div style="width: 99%">
			...
			<div style="float: left; margin-bottom: 5px">
				<input type="button" value="Thêm khu vực" id="btThem"
