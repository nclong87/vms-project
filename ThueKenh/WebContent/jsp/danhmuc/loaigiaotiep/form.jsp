...
<s:url action="dosaveloaigiaotiep" namespace="/danhmuc" id="doSaveURL" />
	...
	<form id="form" onsubmit="return false;">
		...
		<div
			...
			<table class="input" style="width: 725px">
				...
				<tr>
					<td align="right"><label for="loaigiaotiep">Tên loại
							giao tiếp <font title="Bắt buộc nhập" color="red">*</font> :
					</label></td>
					<td align="left"><input type="text" id="loaigiaotiep"
						name="opEdit.loaigiaotiep"
						value="<s:property value="opEdit.loaigiaotiep" />" /></td>
					<td align="right" width="150px"><label for="stt">Cước
							cổng : </label></td>
					<td align="left"><input type="text" id="cuoccong" name="opEdit.cuoccong"
						value="<s:property value="opEdit.cuoccong" />" /></td>
				</tr>
			...
			.ready(
					function() {
						...
						$("#form").validate({
							...
							messages : {
								"opEdit.loaigiaotiep" : {
									required : "Yêu cầu nhập tên loại giao tiếp"
								},
								"opEdit.stt" : {
						...
						if (form_data != '') {
							...
							$("#loaigiaotiep").attr("disabled", "true");
						}
						$(document)
								.delegate(
										"#btSubmit",
