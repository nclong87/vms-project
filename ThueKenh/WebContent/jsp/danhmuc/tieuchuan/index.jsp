...
<s:url action="ajLoadTieuChuan" namespace="/danhmuc" id="ajLoadData" />
<s:url action="edittieuchuan" namespace="/danhmuc" id="formURL" />
<s:url action="deletetieuchuan" namespace="/danhmuc" id="ajDeleteURL" />
<s:url action="detailtieuchuan" namespace="/danhmuc" id="detailURL" />
...
<script>
	function doNew(link) {
		ShowWindow('Thêm tiêu chuẩn mới', 800, 400, link, false);
	}
	function doEdit(link) {
		ShowWindow('Cập nhật tiêu chuẩn', 800, 400, link, false);
	}
	function hasChecked() {
...
<body>
	...
	<div id="bg_wrapper">
		<center>
		<a class="help" target="_blank" href="<%= request.getContextPath() %>/files/HDSD_v4.0.htm#_Toc352351983" title="Hướng dẫn"></a>
		<div class="ovf" style="width: 100%; margin-bottom: 5px;">
			<div class="s10">
				<div class="fl">
					<div id="t_1" class="fl tsl"></div>
					<div id="t_2" class="fl clg b tsc d">
						<div class="p3t">Quản lí tiêu chuẩn</div>
					</div>
		...
		<div style="width: 99%">
			...
			<div style="float: left; margin-bottom: 5px">
				<input type="button" value="Thêm tiêu chuẩn" id="btThem"
											...
											"aoColumns" : [
													{
														...
														"fnRender" : function(
																oObj) {
															return '<a target="_blank" href="${detailURL}?id='+oObj.aData.ID+'" title="Xem chi tiết tiêu chuẩn">'+oObj.aData.ID+'</a>';
														}
													},
													{
														"mDataProp" : "STT",
