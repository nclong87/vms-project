...
<s:url action="ajLoaddoitac" namespace="/danhmuc"
	id="ajLoadURL" />
	...
	<div class="s10">
		<div class="fl">
			...
			<div class="fl clg b tsc d" id="t_2">
				<div class="p3t">Tìm kiếm đối tác</div>
			</div>
...
<div style="clear: both; margin: 5px 0">
	<input type="button" class="button" value="Thêm đối tác"
		onclick="ShowWindow('Thêm đối tác',400,200,'${formURL}',false);"></input>
...
function doEdit(url){
	ShowWindow('Sửa đối tác',400,200,url,false);
}
