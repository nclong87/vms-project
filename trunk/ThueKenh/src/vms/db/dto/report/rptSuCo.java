...
public class rptSuCo {
	public static String toXML(ResultSet rs) throws SQLException {
		...
		buffer.append(VMSUtil.xml("loaisuco", rs.getInt("LOAISUCO")==0?"Thường":"Lớn"));
		buffer.append(VMSUtil.xml("nguoixacnhan", rs.getString("NGUOIXACNHAN")));
		buffer.append(VMSUtil.xml("phuonganxuly", rs.getString("PHUONGANXULY")));
