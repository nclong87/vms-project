...
<s:url action="rpGiamTruMatLienLac" namespace="/baocao" var="rpGiamTruMatLienLacURL"/>
...
<body>
	<%@include file="/include/top.jsp"%>
		<div id="bg_wrapper">
			<a class="help" target="_blank" href="<%= request.getContextPath() %>/files/HDSD_v4.0.htm#_Toc352351973" title="Hướng dẫn"></a>
				...
				<div class="s10">
					<div class="fl">
						...
						<div class="fl clg b tsc d" id="t_2">
							<div class="p3t">Báo cáo giảm trừ mất liên lạc</div>
						</div>
