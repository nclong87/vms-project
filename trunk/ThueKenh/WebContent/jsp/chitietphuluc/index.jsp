		...
		$.ajax({
			...
			success: function(response){
				...
				if(response.status == "ERROR") {
					...
					showDialogUrl("${formURL}?cuocDauNoi="+response.data.cuocDauNoi+"&giaTriTruocThue="+response.data.giaTriTruocThue+"&giaTriSauThue="+response.data.giaTriSauThue+"&soLuongKenh="+encodeURIComponent(response.data.soLuongKenh)+"&id=","Lưu giá trị phụ lục",500);
				}
			},
