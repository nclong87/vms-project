	...
	<form id="form" onsubmit="return false;">
		...
		<div
			...
			<table class="input" style="width: 725px">
				...
				<tr>
					<td align="right"><label for="tentieuchuan">Tên tiêu chuẩn
					 <font title="Bắt buộc nhập" color="red">*</font> :
					</label></td>
					<td align="left"><input type="text" id="tentieuchuan"
						name="opEdit.tentieuchuan"
			...
			.ready(
					function() {
						...
						$("#form").validate({
							...
							messages : {
								"opEdit.tentieuchuan" : {
									required : "Yêu cầu nhập tên tiêu chuẩn"
								},
								"opEdit.stt" : {
