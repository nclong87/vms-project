...
<s:url action="ajLoadduan" namespace="/danhmuc"
	id="ajLoadURL" />
	...
	<div class="s10">
		<div class="fl">
			...
			<div class="fl clg b tsc d" id="t_2">
				<div class="p3t">Tìm kiếm dự án</div>
			</div>
...
<div style="clear: both; margin: 5px 0">
	<input type="button" class="button" value="Thêm dự án"
		onclick="ShowWindow('Thêm dự án',400,200,'${formURL}',false);"></input>
...
function doEdit(url){
	ShowWindow('Sửa dự án',400,200,url,false);
}
