...
<s:url action="ajLoadDiemDauCuoi" namespace="/danhmuc" id="ajLoadData" />
<s:url action="editDiemDauCuoi" namespace="/danhmuc" id="formURL" />
<s:url action="deleteDiemDauCuoi" namespace="/danhmuc" id="ajDeleteURL" />
...
<script>
	function doNew(link) {
		ShowWindow('Thêm điểm đầu, cuối mới', 800, 400, link, false);
	}
	function doEdit(link) {
		ShowWindow('Cập nhật điểm đầu, cuối', 800, 400, link, false);
	}
	function hasChecked() {
	...
	<div id="bg_wrapper">
			...
			<div class="s10">
				<div class="fl">
					...
					<div id="t_2" class="fl clg b tsc d">
						<div class="p3t">Quản lí điểm đầu, cuối</div>
					</div>
		...
		<div style="width: 99%">
			...
			<div style="float: left; margin-bottom: 5px">
				<input type="button" value="Thêm điểm đầu, cuối" id="btThem"
