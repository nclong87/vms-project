...
<script>
	function doNew(link) {
		ShowWindow('Thêm loại giao tiếp mới', 800, 400, link, false);
	}
	function doEdit(link) {
		ShowWindow('Cập nhật loại giao tiếp', 800, 400, link, false);
	}
	function hasChecked() {
...
<body>
	...
	<div id="bg_wrapper">
		<center>
		<a class="help" target="_blank" href="<%= request.getContextPath() %>/files/HDSD_v4.0.htm#_Toc352351985" title="Hướng dẫn"></a>
		<div class="ovf" style="width: 100%; margin-bottom: 5px;">
			<div class="s10">
				<div class="fl">
					<div id="t_1" class="fl tsl"></div>
					<div id="t_2" class="fl clg b tsc d">
						<div class="p3t">Quản lí loại giao tiếp</div>
					</div>
		...
		<div style="width: 99%">
			...
			<div style="float: left; margin-bottom: 5px">
				<input type="button" value="Thêm loại giao tiếp" id="btThem"
			...
			<table width="100%" id="dataTable" class="display">
				<thead>
					<tr>
						...
						<th width="5%">ID</th>
						<th width="10%">Mã</th>
						<th>Tên loại giao tiếp</th>
						<th width="10%">Cước cổng</th>
