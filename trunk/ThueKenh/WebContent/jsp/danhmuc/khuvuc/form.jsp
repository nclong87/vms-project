...
<s:url action="dosavekhuvuc" namespace="/danhmuc" id="doSaveURL" />

<s:set value="opEdit.ma" var="ma"/>
<s:set value="opEdit.stt" var="stt"/>
<s:set value="opEdit.tenkhuvuc" var="tenkhuvuc"/>
	...
	<form id="form" onsubmit="return false;">
		...
		<div
			...
			<table class="input" style="width: 725px">
				...
				<tr>
					<td align="right"><label for="tenkhuvuc">Tên khu vực <font title="Bắt buộc nhập" color="red">*</font> :
					</label></td>
					<td align="left"><input type="text" id="tenkhuvuc"
						name="opEdit.tenkhuvuc"
						value="<s:property value="opEdit.tenkhuvuc" />" /></td>
			...
			.ready(
					function() {
						$("#btReset").click(function() {
							$("#ma").attr("value","${ma}");
							$("#stt").attr("value","${stt}");
							$("#tenkhuvuc").attr("value","${tenkhuvuc}");
						});
						$("#form").validate({
							onkeyup : false,
							onfocusout : false,
							...
							messages : {
								"opEdit.tenkhuvuc" : {
									required : "Yêu cầu nhập tên khu vực"
								},
								"opEdit.stt" : {
