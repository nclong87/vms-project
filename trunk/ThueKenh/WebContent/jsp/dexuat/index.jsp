...
<body>
	...
	<div id="bg_wrapper">
		<a class="help" target="_blank" href="<%= request.getContextPath() %>/files/HDSD_v4.0.htm#_Toc352351958" title="Hướng dẫn"></a>
...
$(document).ready(function(){	 
	...
	$("#btThem").click(function(){
		ShowWindow('Thêm mới  văn bản đề xuất',750,500,"${formURL}",true);
		MaxWindow();
	});
